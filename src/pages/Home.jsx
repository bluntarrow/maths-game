...
const Home = () => {
  ...
  return (
    <div className="h-screen w-screen">
      <div className="grid grid-cols-5 gap-4 md:gap-10 h-full max-w-5xl mx-auto py-20 px-4">
        {/* games grid */}
        ...
        <div className="col-span-5 md:col-span-2 rounded shadow-sm bg-white border">
          ...
          <ul className="p-6 grid grid-cols-2 grid-rows-2 gap-6 text-gray-600">
            {scores.map((score) => (
              <li key={score.name}>
                <Popover as="div" className="relative w-full h-full">
